...
class UpdateHoldingsProvider(object):
    ...
    def __init__(self, cachePath, useCache, **kwargs):
        ...
        #
        baseUrl = kwargs.get("updateTargetUrl", "https://prerelease.k8s.rcsb.org/pub/pdb/data/status/latest")
        fallbackUrl = kwargs.get("updateFallbackUrl", "https://prerelease.k8s.rcsb.org/pub/pdb/data/status/latest")
        #
