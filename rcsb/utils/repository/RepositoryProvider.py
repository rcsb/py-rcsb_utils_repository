...
class RepositoryProvider(object):
    ...
    def __init__(self, cfgOb, cachePath=None, numProc=8, fileLimit=None, verbose=False, discoveryMode=None):
        ...
        self.__baseUrlPDB = self.__cfgOb.getPath("PDB_REPO_URL", sectionName=self.__configName, default="https://prerelease.k8s.rcsb.org/pub")
        self.__fallbackUrlPDB = self.__cfgOb.getPath("PDB_REPO_FALLBACK_URL", sectionName=self.__configName, default="https://prerelease.k8s.rcsb.org/pub")
    ...
    def __getLocatorRemote(self, contentType, idCode, repositoryLayout="pdbftp"):
        ...
        try:
            ...
            #
                ...
                # https://prerelease.k8s.rcsb.org/pub/pdb/validation_reports/00/100d/100d_validation.xml.gz
